...
% resize buttons
to_start_button_h=findobj(self.fig_h,'tag','to_start_button_h');
page_left_button_h=findobj(self.fig_h,'tag','page_left_button_h');
step_left_button_h=findobj(self.fig_h,'tag','step_left_button_h');
step_right_button_h=findobj(self.fig_h,'tag','step_right_button_h');
page_right_button_h=findobj(self.fig_h,'tag','page_right_button_h');
to_end_button_h=findobj(self.fig_h,'tag','to_end_button_h');
zoom_way_out_button_h=findobj(self.fig_h,'tag','zoom_way_out_button_h');
zoom_out_button_h=findobj(self.fig_h,'tag','zoom_out_button_h');
zoom_in_button_h=findobj(self.fig_h,'tag','zoom_in_button_h');
