  ...
  methods
    function self=View(controller,model)
      ...
      set(self.figure_h, ...
          ...
          'Name','Roving',...
          'NumberTitle','off',...
          'Colormap',roving.colormap_from_name(cmap_name),...
          'DockControls','off', ...
...
%       end
      ...
      % (Formerly hid the Parula menu on pre-R2014b MATLAB via verLessThan;
      % removed -- Parula is in every release this app now supports, and the
      % verLessThan call breaks under R2026a once tmt_116/basics/pad.m shadows
      % the builtin pad that ver depends on.)
      self.jet_menu_h= ...
        uimenu(self.color_menu_h,...
               'Tag','jet_menu_h',...
               'Label','Jet',...
